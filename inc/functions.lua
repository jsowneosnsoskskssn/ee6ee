...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1619524486 or msg.sender_user_id_ == 1910934437 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/jsowneosnsoskskssn/ee6ee/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/jsowneosnsoskskssn/ee6ee/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/jsowneosnsoskskssn/ee6ee/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/jsowneosnsoskskssn/ee6ee/main/inc/functions.lua','./inc/functions.lua')
download_file('https://raw.githubusercontent.com/jsowneosnsoskskssn/ee6ee/main/plugins/games.lua','./plugins/games.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boss..":NameBot:") or "لينا"
...
usernn = data.username_ or "kkexk"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "kkexk"
end
Name = Name:gsub('[[][]]','')
...
result = false
if msg.sender_user_id_ == 1619524486 or msg.sender_user_id_ == 1910934437 then 
SudoBase = true
...
var = 'هذا البوت' 
elseif UserID == 1619524486or UserID == 1910934437 then 
var = 'Legend '
...
message = message ..i.. '( ['..info.username..'](t.me/kkexk) )\n'
end
...
message = message ..k.. '-  ['..info.username..'](t.me/kkexk) l ࿈ (`' ..v.. '`){'..count..'} \n'
end
end 
end
...
message = message ..k.. '-  ['..info.username..'](t.me/kkexk) l ࿈ (`' ..v.. '`) \n'
end
end
end
...
elseif UserID == 1910934437 or UserID == 1619524486 then 
...
if UserID == 1910934437 or UserID == 1619524486 then return sendMsg(ChatID,MsgID,"⇠ مايمديك تنزل Legend!") end
