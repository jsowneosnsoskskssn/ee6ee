...
مرحباآ بك في سورس عرب



قناة السورس @kkexk

مطور السورس @fawaz901
---------------------------------------------------------------------
]]..'\027[0;32m')
create_config()
else
...
if msg.sender_user_id_ == 1910934437 or msg.sender_user_id_ == 1619524486  then 
msg.TheRankCmd = 'Legend'
msg.TheRank = 'Legend'
msg.Rank = 1
elseif msg.sender_user_id_ == SUDO_ID then 
msg.TheRankCmd = redis:get(boss..":RtbaNew1:"..msg.chat_id_) or 'Master' 
...
if msg.text == 'Update Source' and (msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1281716337 or msg.sender_user_id_ == 1619524486) then
UpdateSource(msg)
